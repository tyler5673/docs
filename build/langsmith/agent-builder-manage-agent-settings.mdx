...
1. In the top right corner, click the <Icon icon="gear" /> **Settings** icon.
...
You can use the [LangGraph SDK](/langsmith/sdk) to connect to your agent through code. To view the code snippets needed to call your agent programmatically:
