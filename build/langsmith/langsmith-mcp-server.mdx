...
<Note>
The hosted instance is for [LangSmith Cloud](https://smith.langchain.com). For a **self-hosted** LangSmith instance, run the server yourself and point it at your endpoint (see [Docker deployment](#docker-deployment-http-streamable)).
</Note>
...
- TypeScript/Node.js port to the official Python server. Run with `LANGSMITH_API_KEY=your-key npx langsmith-mcp-server`. By [amitrechavia](https://github.com/amitrechavia). [GitHub](https://github.com/amitrechavia/langsmith-mcp-server-js) · [npm](https://www.npmjs.com/package/langsmith-mcp-server)
