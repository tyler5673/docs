...
| Azure OpenAI | [`langchain-openai`](/oss/javascript/integrations/chat/azure_chat_openai) | `AZURE_OPENAI_API_KEY` | ✅ |
...
| Hugging Face | [`langchain-huggingface`](/oss/javascript/integrations/chat/huggingface) | `HUGGINGFACEHUB_API_TOKEN` | ✅ |
...
| Together | [`langchain-together`](/oss/javascript/integrations/chat/together) | `TOGETHER_API_KEY` | ❌ |
| Mistral AI | [`langchain-mistralai`](/oss/javascript/integrations/chat/mistralai) | `MISTRAL_API_KEY` | ✅ |
| DeepSeek | [`langchain-deepseek`](/oss/javascript/integrations/chat/deepseek) | `DEEPSEEK_API_KEY` | ✅ |
| IBM (watsonx.ai) | [`langchain-ibm`](/oss/javascript/integrations/chat/ibm_watsonx) | `WATSONX_APIKEY` | ❌ |
| Nvidia | [`langchain-nvidia-ai-endpoints`](/oss/javascript/integrations/chat/nvidia_ai_endpoints) | `NVIDIA_API_KEY` | ❌ |
...
| OpenRouter | [`langchain-openrouter`](/oss/javascript/integrations/chat/openrouter) | `OPENROUTER_API_KEY` | ✅ |
