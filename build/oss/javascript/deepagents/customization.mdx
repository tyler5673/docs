...
`createDeepAgent` is an opinionated wrapper that assembles a specific [middleware](/oss/javascript/langchain/middleware/overview) stack and delegates to [`createAgent`](/oss/javascript/langchain/agents) from `langchain`.
...
For more information about middleware, see [Middleware](/oss/javascript/langchain/middleware/overview).
