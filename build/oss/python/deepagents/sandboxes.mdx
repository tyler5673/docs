...
<CardGroup cols={2}>
    ...
    <Card title="Deno" icon="/images/providers/deno-icon.svg" href="/oss/python/integrations/providers/deno">
        Deno/JavaScript workloads, microVMs.
    </Card>
    <Card title="Node VFS" icon="/images/providers/nodejs-icon.svg" href="/oss/python/integrations/providers/node-vfs">
