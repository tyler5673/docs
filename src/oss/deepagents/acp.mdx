...
You can use deep agents with ACP-compatible clients, so your editor can provide project context and receive rich updates.
...
<Card title="Example coding agent" icon="github" href="https://github.com/langchain-ai/deepagents/blob/main/libs/acp/examples/demo_agent.py">
